...
module.exports = [
  /* ------------------------------------------------------------------ 1 */
  {
    ...
    subject: 'Rock the Fall is open',
    altSubjects: ["Fall is here. Let's get to work.", 'My 8-week challenge starts October 5'],
    preview: 'Eight weeks of training with me, starting October 5. Five challengers win $2,000 each.',
    body: (h) => [
      ...
      h.hi(),
      h.p('Enrollment for Rock the Fall is open.'),
      h.p("It's my 8-week challenge. We start Monday, October 5, and I want you in it."),
      h.p("Fall is when routines slip. Back to school, shorter days, and a hundred reasons to skip. Then the holidays show up, and most people decide they'll start over in January."),
      h.p("I built Rock the Fall so you don't have to start over. You walk into the holidays already feeling strong."),
      h.p("Here's what you get:", { bold: true, pb: 14 }),
      h.checklist([
        `${h.b('A daily training plan.')} Follow the Rock the Fall program or any program in the app. Full gym, at home, or on the road. Every one counts.`,
        `${h.b('Simple nutrition guidance, no extremes.')} Plus over $300 in guides, all included.`,
        `${h.b('A community that shows up with you,')} with new mini-challenges and prizes every two weeks.`,
        `${h.b('A chance to win $2,000.')} Five winners, $2,000 each.`,
      ]),
      h.p("You don't have to be the most advanced person in the challenge to win. Winners are chosen on two things: your transformation and how active you are in the community. You just have to show up."),
      h.p("It's $50 for the challenge, or $149 for a full year in the app. You get access as soon as you join, so you can settle in before kickoff."),
      h.button(),
      h.facts(),
  ...
  /* ------------------------------------------------------------------ 2 */
  {
    ...
    body: (h) => [
      ...
      h.p("You don't have to do my recommended program. You can enter the challenge with any program in the Naked Training app, and every one counts toward the prize:"),
      h.checklist([
